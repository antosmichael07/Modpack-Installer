...
int main() {
    ...
    char cmdCommand5[1024] = "echo powershell -Command \"& {Invoke-WebRequest -Uri \\\"https://www.dropbox.com/scl/fi/wfswjtfuj2tlalebf4qyc/mods.zip?rlkey=go53stwd75ujti66qejtsh4g1\"&\"dl=1\\\" -OutFile \\\"mods.zip\\\"}\" >> ";
